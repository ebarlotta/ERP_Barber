<div style="background-color: rgb(160, 178, 212); padding-top:20px;padding-bottom:20px;">
    ...
    <div class="justify-center" style="display: block;text-align: center;">
        <input class="fs-12 col-6 rounded py-2 my-3" type="text" value="Monto" style="text-align: center;">
        <input class="fs-10 col-6 rounded py-2 my-3" type="date" value="Fecha" style="text-align: center;">
        <!-- Cliente -->
        <select class="bg-blue col-11 rounded h-8 my-3" name="" id="" style="background-color: blue; color:white;text-align: center;">
            <option value="">Cliente</option>
        </select>
        <!-- Area -->
        <select class="bg-green col-11 rounded h-8 my-3" name="" id="" style="background-color: green; color:white;text-align: center;">
            <option value="">Área</option>
        </select>
        <!-- Cuenta  -->
        <select class="bg-yellow col-11 rounded h-8 my-3" name="" id="" style="background-color: yellow;text-align: center;">
