        ...
        <div class="header-bot">
            <div class="header-bot_inner_wthreeinfo_header_mid">
                ...
                <div class="col-md-4 logo_agile">
                    <img class="col-md-4" src="http://127.0.0.1:8000/images/BarBer.png" alt=" " style="width: 100px;height: 70px;">
                    <h3 class="col-md-8">
                        Empresa de Pruebas
                        <span>S</span>hoppy
                    </h3>
                                ...
                                <div class="first-row form-group">
                                    ...
                                    <div class="w3_agileits_card_number_grids">
                                        <div class="w3_agileits_card_number_grid_left">
                                            <div class="controls">
                                                <label class="control-label">{{ __("labels.Card_Number")}}</label>
                                    ...
                                    <div class="controls">
                                        <label class="control-label">{{ __("labels.Expiration_Date") }}</label>
                                        <input class="expiration-month-and-year form-control" type="text" name="expiration-month-and-year" placeholder="MM / YY">
                                    </div>
                                </div>
                                <button class="submit">
                                    <span>{{ __("labels.Make_Payment") }} </span>
                                </button>
                            </div>
                        </div>
                    </form>
                ...
                <div class="accordion-body">
                    <div class="vertical_post">
                        <form action="#" method="post">
                            ...
                            <input type="submit" value="{{ __("labels.Pay_Now")}}">
                        </form>
                    </div>
                </div>
              </div>
              ...
              <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <div id="tab4" class="tab-grid" style="display: block;">
                        <div class="row">
                            <div class="col-md-6">
                                <img class="pp-img" src="payment_archivos/paypal.png" alt="Image Alternative text" title="Image Title">
                            ...
                            <div class="col-md-6 number-paymk">
                                <form class="cc-form">
                                    ...
                                    <div class="checkbox checkbox-small">
                                        <label>
                                            <input class="i-check" type="checkbox" checked="checked">{{ __("labels.Add_to_My_Cards") }}</label>
                                    </div>
                                    <input type="submit" class="submit" value="{{ __("labels.Proceed_Payment") }}">
                                </form>
                            </div>
                        </div>
