                            ...
                            <div style="display: flex; flex-wrap: wrap; justify-content: center;">
                                @foreach ($usuariosdelaempresa as $usx)
                                    ...
                                    <div
                                        ...
                                        <div style="position: inherit; justify-content: end; display: flex; margin-right: -21px; margin-top: 5px;"
                                            placeholder="Eliminar" wire:click="EliminarUsuario({{ $usx['id'] }})">
...
id="exampleFormControlInput1" placeholder="Ingrese Descripcion" wire:model="name">
@error('name') <span class="text-red-500">{{ $message }}</span>@enderror --}}
                            <select>
                                @foreach ($usuariosglobales as $usuarioglobal)
                                    <option></option>
                                @endforeach
                            </select>
                        </div>
