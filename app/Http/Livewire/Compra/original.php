...
function LlamarFiltro($Proveedores,$Mes,$ParticipaEnIva,$Areas,$Cuentas,$Anio,$Detalle2,$Orden,$ConSaldo,$Pagina, $Iva) {
	$objResponse = new xajaxResponse();
		if ($Proveedores<>" ") {
		  if ($a<>"") { $a=$a." and "; }
		...
		if ($Iva<>" ") {     //Revisa que se haya especificado en el filtro algún iva del comprobante
		    if ($a<>"") { $a=$a." and "; }
		    $a=$a." IvaComp=$Iva ";
		}
...
$Filtro='onchange="xajax.call(\'LlamarFiltro\', {method: \'get\', parameters:[FProveedores.value,FMes.value,FParticipaIva.value,FAreas.value,FCuentas.value,FAnio.value,FDetalle2.value,FOrden.checked,FConSaldo.checked,Pagina.value,FIva.value]});return false;"';
...
function CargarAreasCuentas1($Empresa) {
	...
	$Eventos=' onchange="xajax.call(\'LlamarFiltro\', {method: \'get\', parameters:[FProveedores.value,FMes.value,FParticipaIva.value,FAreas.value,FCuentas.value,FAnio.value,FDetalle2.value,FOrden.checked,FConSaldo.checked,Pagina.value,FIva.value]})"';
...
<!-- <body class="yui-skin-sam" onload="xajax.call('CargarAreasCuentas1', {method: 'get', parameters:[cmbEmpresas.value]});"> -->
  		...
  		echo '<body onload="xajax.call(\'CargarAreasCuentas1\', {method: \'get\', parameters:['.$_SESSION['CuitEmpresa'].']});">';
  		...
  		?>
<?php 
$ElFiltro= ' onchange="xajax.call(\'LlamarFiltro\', {method: \'get\', parameters:[FProveedores.value,FMes.value,FParticipaIva.value,FAreas.value,FCuentas.value,FAnio.value,FDetalle2.value,FOrden.checked,FConSaldo.checked,Pagina.value,FIva.value]});"';
...
<ul class="nav nav-tabs style="padding-top:5px;"">    
  <li class="nav-item"><a class="nav-link active"<a data-toggle="tab" href="#pillGestionar">Gestionar Comprobantes</a></li>
  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pills-CtasCtes">Cuentas Corrientes</a></li>
  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pills-Deuda">Deuda a Proveedores</a></li>
  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pills-Credito">Cr&eacute;dito de Proveedores</a></li>
  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pills-DeudaXArea">Deuda por area/sector</a></li>
  <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#pills-Libros">Libros de Iva</a></li>
</ul>
...
<table border="1" style="font-size : 1px; margin-bottom: 0px;" class="table table-responsive table-hover">
  <tbody bgcolor="#EFF3F7" bordercolor="#FFFFFF" style="font-family : Verdana; font-size : 12px; font-weight : 300;">
    <tr>
		<td>
			<div id="Empresas">
                ...
                $ElFiltro2=' xajax.call(\'LlamarFiltro\', {method: \'get\', parameters:[FProveedores.value,FMes.value,FParticipaIva.value,FAreas.value,FCuentas.value,FAnio.value,FDetalle2.value,FOrden.checked,FConSaldo.checked,Pagina.value,FIva.value]});';
                ?>
            ...
            <table border="1" class="table table-responsive table-hover">
              <tbody bgcolor="#EFF3F7" bordercolor="#FFFFFF" style="font-family : Verdana; font-size : 12px; font-weight : 300;">
                ...
                <tr>
                  ...
                  <td>
                    <SELECT id="Anio" name="Anio"><OPTION>2021</OPTION><OPTION>2020</OPTION><OPTION>2019</OPTION><OPTION>2018</OPTION><OPTION>2017</OPTION><OPTION>2016</OPTION><OPTION>2015</OPTION><OPTION>2014</OPTION><OPTION>2013</OPTION><OPTION>2012</OPTION><OPTION>2011</OPTION><OPTION>2010</OPTION></SELECT>
				  </td>
            	  <!-- <td> -->
                  ...
                  <td>
                    <div id="DivPasadoEnMes">
                      <?php $Eventos='onkeypress="javascript:if(getKeyCode(event)==13) document.forms[0].cmbAreas.focus();"'; CargarCombo("PasadoEnMes","","","Meses","Meses","PasadoEnMes"," ",$Eventos,90,1,0); ?>
                    </div>
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td align="center">
                    <div id="DivParticIva">
                      <?php $Eventos='onkeypress="javascript:if(getKeyCode(event)==13) document.forms[0].PasadoEnMes.focus();"'; CargarCombo("ParticIva","tblParticIva","DescripcionPartic","DescripcionPartic","","ParticIva","",$Eventos,50,1,0); ?>
				      <SELECT name="Iva" id="Iva" onkeypress="javascript:if(getKeyCode(event)==13) document.forms[0].Exento.focus();" onchange="CalcularNeto();" onclick="javascript:if(getKeyCode(event)==13) document.forms[0].Exento.focus();" ><OPTION>21.00</OPTION><OPTION>10.50</OPTION><OPTION>27.00</OPTION><OPTION>0.00</OPTION></SELECT>
				    </div>
				  </td>
                  <td align="center">
    ...
    <Table title="Filtrar por:" border="1" class="table table-responsive table-hover">
      <tr>
        <td align="center"><b>Actualiz</b></td><td align="center">Mes</td><td align="center">Proveedor</td><td align="center">ParticIva</td><td align="center">Iva</td><td align="center">Detalle</td><td align="center">Area</td><td align="center">Cuenta</td><td align="center">MostrarTodos</td><td align="center">A&ntilde;o</td><td align="center">Asc. C/Saldo</td>
      </tr>
      <tr>
      	<?php
        $Filtro=' onchange="xajax.call(\'LlamarFiltro\', {method: \'get\', parameters:[FProveedores.value,FMes.value,FParticipaIva.value,FAreas.value,FCuentas.value,FAnio.value,FDetalle2.value,FOrden.checked,FConSaldo.checked,Pagina.value,FIva.value]});"';
        echo '<td align="center">
                <input type="button" onclick="xajax.call(\'LlamarFiltro\', {method: \'get\', parameters:[FProveedores.value,FMes.value,FParticipaIva.value,FAreas.value,FCuentas.value,FAnio.value,FDetalle2.value,FOrden.checked,FConSaldo.checked,Pagina.value,FIva.value]});">
              </td>';
        ?>
        <td align="center">
        ...
        <td align="center">
        	<?php CargarCombo("FIva","tblIva","DescripcionIva","MontoIva","","ParticIva"," ",$Filtro,30,1,0); ?>
        </td>
        <td align="center">
        	<div id="Detallen">
        ...
        <td align="center">
        	<SELECT name="FFiltrar"><OPTION>Si</OPTION><OPTION>No</OPTION></SELECT>
        </td>
        <td align="center">
        	<SELECT name="FAnio" id="FAnio" <?php echo $Filtro;?> ><OPTION value="2021">2021</OPTION><OPTION value="2020">2020</OPTION><OPTION value="2019">2019</OPTION><OPTION value="2018">2018</OPTION><OPTION value="2017">2017</OPTION><OPTION value="2016">2016</OPTION><OPTION value="2015">2015</OPTION><OPTION value="2014">2014</OPTION><OPTION value="2013">2013</OPTION><OPTION value="2012">2012</OPTION><OPTION value="2011">2011</OPTION><OPTION value="2010">2010</OPTION></SELECT>
        </td>
        <td align="center">
...
<div id="Botonera">
  ...
  <div class="tab-pane fade" id="pills-CtasCtes" role="tabpanel" aria-labelledby="pills-CtasCtes-tab">

<table title="Filtrar por:" border="1">
  <tr>
    <td>Mes</td><td>Proveedor</td><td>ParticIva</td><td>Detalle</td><td>Area</td><td>Cuenta</td><td>MostrarTodos</td><td>Desde</td><td>Hasta</td><td>Empresa</td><td>IVA</td><td>A&ntilde;o</td><td>ASC/DESC</td>
  </tr>
  <tr><?php 
$Filtro2='onClick="
...
?>
    ...
    <td><?php ?><div id="ProveedoresDeuda"></div></td>
    <td>
	<?php CargarCombo("FParticipaIva2","tblParticIva","DescripcionPartic","DescripcionPartic","","ParticIva"," ",$Filtro2,30,1,0); ?></td>
    <td><div id="DetalleCB"><?php CargarCombo("FDetalleSCBancarias", "tblComprobantes",  "distinct DetalleComp", "", "","Detalle"," ",$Filtro2,100,1,0); ?></div></td>
    ...
    <td><SELECT id="F2Anio" name="F2Anio" <?php $Filtro2 ?>><OPTION>Todos</OPTION><OPTION>2021</OPTION><OPTION>2020</OPTION><OPTION>2019</OPTION><OPTION>2018</OPTION><OPTION>2017</OPTION><OPTION>2016</OPTION><OPTION>2015</OPTION><OPTION>2014</OPTION><OPTION>2013</OPTION><OPTION>2012</OPTION></SELECT></td>
...
-->
	   ...
	   <SELECT name="DeudaAnio" id="DeudaAnio"> <OPTION value="Todos">Todos</OPTION><OPTION value="2021">2021</OPTION><OPTION value="2020">2020</OPTION><OPTION value="2019">2019</OPTION><OPTION value="2018">2018</OPTION><OPTION value="2017">2017</OPTION><OPTION value="2016">2016</OPTION><OPTION value="2015">2015</OPTION><OPTION value="2014">2014</OPTION><OPTION value="2013">2013</OPTION><OPTION value="2012">2012</OPTION></SELECT><br>
...
<div id="DivCmbCredito"></div>
	...
	<?php
	   ...
	   echo '<input class="ButtonAceptar" type="button" onclick="var xxx=\'../sistema/DeudaProveedoresPDF.php?mas=\'+getElementById(\'cmbAreasDeudasProov\').value; window.open(xxx,\'nuevaVentana\',\'width=300, height=400\');" value="Generar PDF">';
        ...
        echo '<SELECT name="CreditoAnio" id="CreditoAnio"> <OPTION value="Todos">Todos<OPTION value="2021">2021</OPTION></OPTION><OPTION value="2020">2020</OPTION><OPTION value="2019">2019</OPTION><OPTION value="2018">2018</OPTION><OPTION value="2017">2017</OPTION><OPTION value="2016">2016</OPTION><OPTION value="2015">2015</OPTION><OPTION value="2014">2014</OPTION><OPTION value="2013">2013</OPTION><OPTION value="2012">2012</OPTION></SELECT><br>';
...
<!-- DEUDA POR AREA
    ======================= -->
<div class="tab-pane fade" id="pills-DeudaXArea" role="tabpanel" aria-labelledby="pills-DeudaXArea-tab">
<?php 
...
<!-- 	<input class="ButtonAceptar" type="button" onclick="var xxx='../sistema/DeudaPorAreasPDF.php'; window.open(xxx,'nuevaVentana','width=300, height=400');" value="Generar PDF"><br> -->
	...
	A&ntilde;o <SELECT id="AreasAnio" name="AreasAnio" <?php $Filtro ?>><OPTION>2021</OPTION><OPTION>2020</OPTION><OPTION>2019</OPTION><OPTION>2018</OPTION><OPTION>2017</OPTION><OPTION>2016</OPTION><OPTION>2015</OPTION><OPTION>2014</OPTION><OPTION>2013</OPTION><OPTION>2012</OPTION></SELECT><br>
...
<!-- LIBROS DE IVA
    ======================= -->
<div class="tab-pane fade" id="pills-Libros" role="tabpanel" aria-labelledby="pills-Libros-tab">
<?php 
	   ...
	   //$Filtro="onChange=\"var PasadoEnMes=getElementById('LibroMes') ; var Empresa=getElementById('cmbEmpresasLibroIva'); var Anio=getElementById('LibroAnio'); var xxx='../sistema/LibroIvaPDF.php?PasadoEnMes=' + PasadoEnMes.value + '&Anio=' + Anio.value + '&Empresa=' + Empresa.value + '&Compra=1'; window.open(xxx,'nuevaVentana','width=300, height=400')\"";
    	...
    	echo '<SELECT name="LibroAnio" id="LibroAnio" '.$EventCerrar.'><OPTION>2021</OPTION><OPTION>2020</OPTION><OPTION>2019</OPTION><OPTION>2018</OPTION><OPTION>2017</OPTION><OPTION>2016</OPTION><OPTION>2015</OPTION><OPTION>2014</OPTION><OPTION>2013</OPTION><OPTION>2012</OPTION> <OPTION>2011</OPTION> <OPTION>2010</OPTION> </SELECT></td>';
	   ...
	   ////echo '<br><SELECT name="LibroAnio" id="LibroAnio"><OPTION>2019</OPTION><OPTION>2021</OPTION><OPTION>2020</OPTION><OPTION>2018</OPTION><OPTION>2017</OPTION><OPTION>2016</OPTION> <OPTION>2015</OPTION><OPTION>2014</OPTION><OPTION>2013</OPTION><OPTION>2012</OPTION> <OPTION>2011</OPTION><OPTION>2010</OPTION></SELECT>'; ?>
		<td>
  ...
  xajax.call('DibujarLibrosCerrados', {method: 'get', parameters:[LibroAnio.value]}); return false;"></td></tr>
  <tr><td colspan="2">
